...
import ConnectButton from '../ConnectButton2';
...
export default function Hero() {
  return (
    <section className="relative overflow-hidden bg-gradient-to-b from-[#8A2BE2]/5 via-white to-white py-24 md:min-h-[80vh]">
      ...
      <div className="container mx-auto px-5 md:px-8 lg:px-10 xl:px-12"> {/* Increased padding */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16 items-center">
          <div className="relative z-10">
            ...
            <p className="text-lg text-[#191A23]/80 mb-8 max-w-lg lg:max-w-xl">
          ...
          {/* Image section */}
          <div className="relative h-full min-h-[400px] -mx-2 md:mx-0"> {/* Adjusted negative margin */}
            <div className="absolute inset-0 bg-gradient-to-br from-[#8A2BE2]/20 to-[#B9FF66]/20 rounded-3xl" />
            <div className="relative h-full w-full overflow-hidden rounded-3xl shadow-2xl">
              <Image
                src="/images/cover.jpg"
                alt="Blockchain verified certificates illustration"
                fill
